...
class Match(models.Model):
    ...
    players = models.ManyToManyField(to=TennisPlayer, related_name='match_players')
    winner = models.ForeignKey(to=TennisPlayer, on_delete=models.SET_NULL, null=True, related_name='match_winner')
